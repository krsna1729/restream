...
- Bench profile only: `scripts/resource-limit cargo build --profile bench`,
  `scripts/resource-limit cargo bench --bench <name>`. Never `--release`,
...
1. Run `scripts/resource-limit target/bench/test_harness resource-sweep`
