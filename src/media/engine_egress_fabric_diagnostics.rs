...
fn srt_owner_json(
    ...
    serde_json::json!({
        ...
        "txClass": {
            "dataFirst": owner.tx_class.data_first,
            "dataRetransmit": owner.tx_class.data_retx,
            ...
            "dropRequest": owner.tx_class.dropreq,
            "keyMaterial": owner.tx_class.km,
            "shutdown": owner.tx_class.shutdown,
            "otherControl": owner.tx_class.other_control,
        },
        ...
        "callerInFlightHwm": owner.caller_in_flight_hwm,
        "callerQueuedHwm": owner.caller_queued_hwm,
        "callerQueueLongestUs": owner.caller_queue_longest_us,
