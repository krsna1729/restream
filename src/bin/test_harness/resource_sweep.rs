...
#[path = "resource_sweep/packet_contract_run.rs"]
mod packet_contract_run;
...
#[path = "resource_sweep/packet_contract_verdict_tests.rs"]
#[cfg(test)]
mod packet_contract_verdict_tests;
