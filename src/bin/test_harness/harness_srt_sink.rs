...
async fn sink_port(
    ...
    // Same park as production ingress: Tokio readable + 5ms tick.
    // HighResWaiter.wait() on this Tokio UdpSocket failed quiet BBB N=30
    // sink/srt-only after #153 (receivers stopped ACKing).
