...
impl ServerSession {
    ...
    /// Bytes the inbound chunk deserializer currently holds (unprocessed
    /// input plus a partially assembled message). (restream vendor patch)
    pub fn inbound_buffered_bytes(&self) -> usize {
        self.deserializer.in_progress_bytes()
    }
    ...
    pub fn new(
        ...
        session
            .deserializer
            .set_max_message_length(config.max_message_length as usize);
