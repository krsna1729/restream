...
assert_contains "/js/app/dashboard-v2-entry.js" "dashboard-v2-overview"
assert_contains "/js/app/dashboard-v2-checkpoints-entry.js" "dashboard-v2-pipeline-inspect-root"
assert_contains "/js/app/dashboard-v2-jsx-runtime.js" "jsx"
